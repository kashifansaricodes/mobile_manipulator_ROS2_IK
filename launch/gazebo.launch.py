...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('mobilearm'),
        'worlds',
        'construction_area.world'
    )
    package_path = get_package_share_directory('mobilearm')
    ...
    pkg_robotaxi_gazebo = get_package_share_directory('mobilearm')
