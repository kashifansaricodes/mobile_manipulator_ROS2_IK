...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'mobilearm.urdf'
    xacro_file = "mobilearm.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "mobilearm"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("mobilearm"), "rviz", "display_default.rviz"]
    )
